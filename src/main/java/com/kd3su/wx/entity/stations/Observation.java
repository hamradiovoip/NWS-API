...
public class Observation {
	...
	@Override
	public int hashCode() {
		return Objects.hash(barometricPressure, dewpoint, heatIndex, location, maxTemperatureLast24Hours,
				minTemperatureLast24Hours, name, precipitationLast3Hours, precipitationLast6Hours,
				precipitationLastHour, rawMessage, relativeHumidity, seaLevelPressure, station, temperature,
				textDescription, timestamp, visibility, windChill, windDirection, windGust, windSpeed);
	}
	@Override
